...
function AboutPerson(props) {
  return (
    <div className="card col-3">
      <img style={{minHeight: '200px'}} src="..." className="card-img-top bg-secondary"/>
    ...
    render() {
      return (
        <div>
          ...
          <p className="text-center">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quaerat incidunt magnam provident reiciendis repellat soluta at cum fugiat veritatis quasi, aspernatur, alias porro, quod quidem qui saepe voluptatum dicta culpa.
          </p>
          <div className='row justify-content-around mt-5'>
            <AboutPerson name="Ariel Slavinsky" about="text about me..."/>
            <AboutPerson name="Roee Navon" about="text about me..."/>
            <AboutPerson name="Ron Perlman" about="text about me..."/>
          </div>
